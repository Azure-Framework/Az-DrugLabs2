# A z D ru gL ab s 2.0

A z D ru gL ab s 2.0 is part of the Az-Framework Summer 2.0 activity pack. It registers with Az-Summer2Core for routes, contracts, rewards, validation, and dispatch hooks.
